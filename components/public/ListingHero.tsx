...
function HeroWave() {
  return (
    <div
      aria-hidden
      className="pointer-events-none absolute inset-x-0 bottom-0 z-20 h-[52px] sm:h-[64px] lg:h-[72px]"
    >
      {/* Stretch the path to the box so it never letterboxes in the middle of the navy. */}
      <svg
        viewBox="0 0 1440 72"
