...
/**
 * Loading State for Applications List Page
 *
 * Skeleton screen matching the layout of the applications page
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="h-6 bg-mist rounded-lg w-64 mt-2 animate-pulse" />
      </div>
